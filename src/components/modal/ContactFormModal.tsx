...
<form className="w-full">
  ...
  <div className="relative z-0 w-full mb-5 group">
    ...
    <div className="relative z-0 w-full mb-5 group">
        <textarea  name="floating_message" id="floating_message" rows="4" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
    ...
    <PrimaryButton onClick={toggleModal} type="submit" label="Send message"/>
    <SecondaryButton type="reset" label="Reset" className="ms-3"/>
    </form>
